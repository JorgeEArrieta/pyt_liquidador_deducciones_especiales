...
from ver_deducciones import VerDeducciones
from crud_bd import lista_empleados
from crud_bd import lect_bbdd_rem_deduc

class VisualizarDeduc(QDialog):

    def __init__(self, ventana: QDialog):
        
        #Declararción del formulario.
        super().__init__(ventana)
        frm_lista_deduc = ventana
        frm_lista_deduc.setObjectName("frm_lista_deduc")
        frm_lista_deduc.resize(601, 329)
        frm_lista_deduc.setMinimumSize(601, 329)
        frm_lista_deduc.setMaximumSize(601, 329)
        frm_lista_deduc.setWindowFlags(QtCore.Qt.WindowCloseButtonHint)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("img/windows/main.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        frm_lista_deduc.setWindowIcon(icon)

        #Labels.
        self.lbl_0 = QLabel(frm_lista_deduc)
        self.lbl_0.setGeometry(QtCore.QRect(10, 10, 41, 16))
        self.lbl_0.setObjectName("lbl_0")
        
        self.lbl_1 = QLabel(frm_lista_deduc)
        self.lbl_1.setGeometry(QtCore.QRect(170, 10, 31, 16))
        self.lbl_1.setObjectName("lbl_1")

        self.lbl_2 = QLabel(frm_lista_deduc)
        self.lbl_2.setGeometry(QtCore.QRect(330, 10, 31, 16))
        self.lbl_2.setObjectName("lbl_2")

        #Combo Box.
        self.cmb_legajo = QComboBox(frm_lista_deduc)
        ...
        self.cmb_year = QComboBox(frm_lista_deduc)
        ...
        self.cmb_mes = QComboBox(frm_lista_deduc)
        ...
        self.tw_empleados = QTableWidget(frm_lista_deduc)
        ...
        self.btn_cerrar = QPushButton(frm_lista_deduc, clicked=frm_lista_deduc.close)
        self.btn_cerrar.setGeometry(QtCore.QRect(520, 290, 75, 23))
        self.btn_cerrar.setObjectName("btn_cerrar")
        
        self.btn_ver = QPushButton(frm_lista_deduc, clicked=self.ver_deduc)
        self.btn_ver.setGeometry(QtCore.QRect(440, 290, 75, 23))
        self.btn_ver.setObjectName("btn_ver")

        self.btn_actualiza = QPushButton(frm_lista_deduc, clicked = self.on_cmb_click)
        self.btn_actualiza.setGeometry(QtCore.QRect(360, 290, 75, 23))
        self.btn_actualiza.setObjectName("btn_actualiza")

        QtCore.QMetaObject.connectSlotsByName(frm_lista_deduc)

        _translate = QtCore.QCoreApplication.translate
        frm_lista_deduc.setWindowTitle(_translate("frm_lista_deduc", "Listado de deducciones"))
        self.lbl_0.setText(_translate("frm_lista_deduc", "Legajo:"))
        self.lbl_1.setText(_translate("frm_lista_deduc", "Año:"))
        self.lbl_2.setText(_translate("frm_lista_deduc", "Mes:"))
        self.btn_cerrar.setText(_translate("frm_lista_deduc", "Cerrar"))
        self.btn_ver.setText(_translate("frm_lista_deduc", "Ver"))
        self.btn_actualiza.setText(_translate("frm_lista_deduc", "Actualizar"))
        ...
        self.actualiza_treeview('deduc', legajo, month, year)
    ...
    def actualiza_treeview(self, tabla, legajo, month, year):
        ...
        try:
            ...
            self.tw_empleados.setHorizontalHeaderItem(1, item_nomap)
            ...
            item_legajo.setText(_translate("frm_lista_deduc", "Número de legajo"))
            item_legajo = self.tw_empleados.horizontalHeaderItem(0) 
            item_nomap.setText(_translate("frm_lista_deduc", "Nombre y Apellido"))
            item_nomap = self.tw_empleados.horizontalHeaderItem(1)
            item_ann.setText(_translate("frm_lista_deduc", "Año"))
            item_ann = self.tw_empleados.horizontalHeaderItem(2)
            item_mes.setText(_translate("frm_lista_deduc", "Mes"))
            item_mes = self.tw_empleados.horizontalHeaderItem(3)
            item_importe.setText(_translate("frm_lista_deduc", "Importe"))
    ...
    def on_cmb_click(self):
        ...
        """
        Maneja los eventos de cambio de información en los combo box.
        """
    ...
    def registro_actual(self):
        ...
        try:
            ...
            ann = self.tw_empleados.item(row, 2).text()
    ...
    def ver_deduc(self):
        ...
        try:
            ...
            datos = self.registro_actual()
            
            if datos != None:
                frm_dialog = QDialog()
                VerDeducciones(datos[0], datos[1], frm_dialog)
                frm_dialog.exec_()
