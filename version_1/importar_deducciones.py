...
from importacion import guarda_deducciones

class ImportaDeducciones(object):
    ...
    def __init__(self, ventana: QDialog):
        ...
        self.frm_imp_deduc = ventana
        self.frm_imp_deduc.setObjectName("frm_imp_deduc")
        self.frm_imp_deduc.setWindowModality(QtCore.Qt.NonModal)
        self.frm_imp_deduc.resize(ancho, alto)
        self.frm_imp_deduc.setMinimumSize(ancho, alto)
        self.frm_imp_deduc.setWindowFlags(QtCore.Qt.WindowCloseButtonHint)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("img/windows/main.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.frm_imp_deduc.setWindowIcon(icon)
        ...
        #Button cerrar
        self.btn_cerrar = QPushButton(self.frm_imp_deduc)
        self.btn_cerrar.setObjectName("btn_cerrar")
        self.gridLayout.addWidget(self.btn_cerrar, 2, 1, 1, 1)
        self.btn_cerrar.clicked.connect(lambda: self.frm_imp_deduc.close())

        #Button importar
        self.btn_importar = QPushButton(self.frm_imp_deduc)
        ...
        #Frame
        self.frame = QFrame(self.frm_imp_deduc)
        ...
        QtCore.QMetaObject.connectSlotsByName(self.frm_imp_deduc)

        _translate = QtCore.QCoreApplication.translate
        self.frm_imp_deduc.setWindowTitle(_translate("frm_imp_deduc", "Importar Deducciones"))
        self.lbl_0.setText(_translate("frm_imp_deduc", "Archivo a importar:"))
        self.btn_directorio.setText(_translate("frm_imp_deduc", "..."))
        self.btn_cerrar.setText(_translate("frm_imp_deduc", "Cerrar"))
        self.btn_importar.setText(_translate("frm_imp_deduc", "Procesar"))

        self.frm_imp_deduc.setLayout(self.gridLayout)
    ...
    def abrir_filedialog(self):
        ...
        file_name = QFileDialog.getOpenFileName(self.frm_imp_deduc,"Seleccionar archivo", "",
    ...
    def procesa_datos(self, archivo):
        ...
        try:
            ...
            self.frm_imp_deduc.resize(ancho, alto)
            self.frm_imp_deduc.setMinimumSize(ancho, alto)
            self.frm_imp_deduc.setMaximumSize(ancho, alto)
            self.frame.setVisible(True)
            self.frm_imp_deduc.setEnabled(False)
        
            x = 0
 
            registros = sueldos_brutos_deducciones(archivo)
            ...
            for registro in registros.values:
                ...
                guarda_deducciones(registro[0], registro[1], registro[2], registro[3], registro[4])
            ...
            self.frm_imp_deduc.setMaximumSize(ancho, alto)
            self.frame.setVisible(False)
            self.frm_imp_deduc.setEnabled(True)
